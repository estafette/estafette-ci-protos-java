...
public final class PaginationOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return contracts.v1.PaginationOuterClass.internal_static_contracts_v1_Pagination_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return contracts.v1.PaginationOuterClass.internal_static_contracts_v1_Pagination_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              contracts.v1.PaginationOuterClass.Pagination.class, contracts.v1.PaginationOuterClass.Pagination.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof contracts.v1.PaginationOuterClass.Pagination)) {
        return super.equals(obj);
      }
      contracts.v1.PaginationOuterClass.Pagination other = (contracts.v1.PaginationOuterClass.Pagination) obj;
    ...
    public static contracts.v1.PaginationOuterClass.Pagination parseFrom(
    ...
    public static contracts.v1.PaginationOuterClass.Pagination parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static contracts.v1.PaginationOuterClass.Pagination parseFrom(
    ...
    public static contracts.v1.PaginationOuterClass.Pagination parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static contracts.v1.PaginationOuterClass.Pagination parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static contracts.v1.PaginationOuterClass.Pagination parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(contracts.v1.PaginationOuterClass.Pagination prototype) {
    ...
    public static final class Builder extends
        ...
        contracts.v1.PaginationOuterClass.PaginationOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return contracts.v1.PaginationOuterClass.internal_static_contracts_v1_Pagination_descriptor;
      }
      ...
      // Construct using contracts.v1.PaginationOuterClass.Pagination.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public contracts.v1.PaginationOuterClass.Pagination getDefaultInstanceForType() {
        return contracts.v1.PaginationOuterClass.Pagination.getDefaultInstance();
      }

      @java.lang.Override
      public contracts.v1.PaginationOuterClass.Pagination build() {
        contracts.v1.PaginationOuterClass.Pagination result = buildPartial();
      ...
      @java.lang.Override
      public contracts.v1.PaginationOuterClass.Pagination buildPartial() {
        contracts.v1.PaginationOuterClass.Pagination result = new contracts.v1.PaginationOuterClass.Pagination(this);
        result.page_ = page_;
        result.size_ = size_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof contracts.v1.PaginationOuterClass.Pagination) {
          return mergeFrom((contracts.v1.PaginationOuterClass.Pagination)other);
        } else {
      ...
      public Builder mergeFrom(contracts.v1.PaginationOuterClass.Pagination other) {
        if (other == contracts.v1.PaginationOuterClass.Pagination.getDefaultInstance()) return this;
        if (other.getPage() != 0L) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        contracts.v1.PaginationOuterClass.Pagination parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (contracts.v1.PaginationOuterClass.Pagination) e.getUnfinishedMessage();
    ...
    private static final contracts.v1.PaginationOuterClass.Pagination DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new contracts.v1.PaginationOuterClass.Pagination();
    }

    public static contracts.v1.PaginationOuterClass.Pagination getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ems\030\004 \001(\003BAZ?github.com/estafette/estafe" +
      "tte-ci-contracts-golang/contracts_v1b\006pr" +
      "oto3"
    };
