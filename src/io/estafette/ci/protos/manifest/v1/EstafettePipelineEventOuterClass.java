...
public final class EstafettePipelineEventOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.internal_static_manifest_v1_EstafettePipelineEvent_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.internal_static_manifest_v1_EstafettePipelineEvent_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent.class, io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent)) {
        return super.equals(obj);
      }
      io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent other = (io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent) obj;
    ...
    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parseFrom(
    ...
    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parseFrom(
    ...
    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent prototype) {
    ...
    public static final class Builder extends
        ...
        io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEventOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.internal_static_manifest_v1_EstafettePipelineEvent_descriptor;
      }
      ...
      // Construct using io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent getDefaultInstanceForType() {
        return io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent.getDefaultInstance();
      }

      @java.lang.Override
      public io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent build() {
        io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent result = buildPartial();
      ...
      @java.lang.Override
      public io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent buildPartial() {
        io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent result = new io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent) {
          return mergeFrom((io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent)other);
        } else {
      ...
      public Builder mergeFrom(io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent other) {
        if (other == io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent();
    }

    public static io.estafette.ci.protos.manifest.v1.EstafettePipelineEventOuterClass.EstafettePipelineEvent getDefaultInstance() {
